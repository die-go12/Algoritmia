...
instruccion
    : asignacion
    | lectura
    | escritura    // Esta ahora exige terminar la línea (gracias al NL superior)
    | condicional
    | while_stmt
    | llamada_proc
    | reproduccion
...
// SOLUCIÓN AL PROBLEMA GLOTÓN:
// Toma múltiples ítems hasta que el parser encuentra el NL definido en 'instrucciones'
escritura:
...
// TRUCO PARA EL PROBLEMA GLOTÓN:
// 1. Saltamos espacios y tabulaciones horizontales
WS: [ \t]+ -> skip;

// 2. Definimos el salto de línea como un token real para usarlo como separador de instrucciones
NL: [\r\n]+ ;
